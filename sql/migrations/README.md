...
| 3 | [`create-pinned-projects.sql`](create-pinned-projects.sql) | Create `pinned_projects` table for per-user pinned-project quick access | FEAT-PINNED-01 (docs-only, no issue) | `data_management` |
