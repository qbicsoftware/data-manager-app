...
(
    ...
    UNIQUE KEY `uk_acl_object_identity`
(
    `object_id_class`,
    `object_id_identity`
),
    KEY `fk_acl_object_identity_parent`
(
    `parent_object`
),
    KEY `fk_acl_object_identity_owner`
(
    `owner_sid`
),
    CONSTRAINT `fk_acl_object_identity_class` FOREIGN KEY
(
    `object_id_class`
...
(
    ...
    CONSTRAINT `fk_acl_object_identity_owner` FOREIGN KEY
(
    `owner_sid`
) REFERENCES `acl_sid`
(
    ...
    CONSTRAINT `fk_acl_object_identity_parent` FOREIGN KEY
(
    `parent_object`
...
(
    ...
    UNIQUE KEY `unique_acl_entry`
(
    `acl_object_identity`,
    `ace_order`
),
    KEY `fk_acl_entry_acl`
(
    `sid`
),
    CONSTRAINT `fk_acl_entry_acl` FOREIGN KEY
(
    `sid`
) REFERENCES `acl_sid`
(
    ...
    CONSTRAINT `fk_acl_entry_object` FOREIGN KEY
(
    `acl_object_identity`
) REFERENCES `acl_object_identity`
(
...
(
    ...
    `principalInvestigatorEmailAddress` varchar
(
    255
) DEFAULT NULL,
    `principalInvestigatorFullName` varchar
(
    255
) DEFAULT NULL,
    `projectCode` varchar
...
(
    ...
    `projectManagerEmailAddress` varchar
(
    255
) DEFAULT NULL,
    `projectManagerFullName` varchar
(
    255
) DEFAULT NULL,
    `responsibePersonEmailAddress` varchar
(
    255
) DEFAULT NULL,
    `responsibePersonFullName` varchar
(
    255
) DEFAULT NULL,
    PRIMARY KEY
...
(
    ...
    `speciesIconName` varchar
(
    31
) NOT NULL DEFAULT 'default',
    `specimenIconName` varchar
(
    31
) NOT NULL DEFAULT 'default',
    `project` varchar
...
(
    ...
    KEY `FKgfrw5hlq3iy6ntf32wy0e8hr`
(
    `project`
),
    CONSTRAINT `FKgfrw5hlq3iy6ntf32wy0e8hr` FOREIGN KEY
(
    `project`
) REFERENCES `projects_datamanager`
(
    `projectId`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FK25vvdiupupuwmehr3o97dh7fg`
(
    `experimentId`
),
    CONSTRAINT `FK25vvdiupupuwmehr3o97dh7fg` FOREIGN KEY
(
    `experimentId`
) REFERENCES `experiments_datamanager`
(
    `id`
)
    ) ENGINE = InnoDB
...
(
    `experimental_group_experimentalGroupId`
    bigint
(
    20
) NOT NULL,
...
(
    ...
    KEY `FKm81bdrf3y2gcsnmhuhjjj3y9j`
(
    `experimental_group_experimentalGroupId`
),
    CONSTRAINT `FKm81bdrf3y2gcsnmhuhjjj3y9j` FOREIGN KEY
(
    `experimental_group_experimentalGroupId`
) REFERENCES `experimental_group`
(
    `experimentalGroupId`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FK4flido9vdvf9uff0g0rngrvpw`
(
    `experimentId`
),
    CONSTRAINT `FK4flido9vdvf9uff0g0rngrvpw` FOREIGN KEY
(
    `experimentId`
) REFERENCES `experiments_datamanager`
(
...
(
    `experimental_variables_variableId`
    bigint
(
    20
) NOT NULL,
...
(
    ...
    KEY `FKfljdny9mdnh19bbm3ii3j4bic`
(
    `experimental_variables_variableId`
),
    CONSTRAINT `FKfljdny9mdnh19bbm3ii3j4bic` FOREIGN KEY
(
    `experimental_variables_variableId`
) REFERENCES `experimental_variables`
(
    `variableId`
)
    ) ENGINE = InnoDB
...
(
    ...
    `analytes` longtext DEFAULT NULL CHECK
(
    json_valid
(
    `analytes`
)),
    KEY `FKenl95t4n6dn8c90mcc9bdi7d3`
(
    `experiments_datamanager_id`
),
    CONSTRAINT `FKenl95t4n6dn8c90mcc9bdi7d3` FOREIGN KEY
(
    `experiments_datamanager_id`
) REFERENCES `experiments_datamanager`
(
...
(
    ...
    `species` longtext DEFAULT NULL CHECK
(
    json_valid
(
    `species`
)),
    KEY `FK5jif824gfi7ho2dmk4lbp2cri`
(
    `experiments_datamanager_id`
),
    CONSTRAINT `FK5jif824gfi7ho2dmk4lbp2cri` FOREIGN KEY
(
    `experiments_datamanager_id`
) REFERENCES `experiments_datamanager`
(
...
(
    ...
    `specimens` longtext DEFAULT NULL CHECK
(
    json_valid
(
    `specimens`
)),
    KEY `FKiebw7ho69dfx9osttd8sin73l`
(
    `experiments_datamanager_id`
),
    CONSTRAINT `FKiebw7ho69dfx9osttd8sin73l` FOREIGN KEY
(
    `experiments_datamanager_id`
) REFERENCES `experiments_datamanager`
(
...
(
    ...
    `systemFreeMemory` bigint
(
    20
) NOT NULL,
    `systemCpuLoad` decimal
(
    3,
    2
) NOT NULL,
    `processMaxMemory` bigint
(
    20
) NOT NULL,
    `processFreeMemory` bigint
(
    20
) NOT NULL,
    `processAllocatedMemory` bigint
(
    20
) NOT NULL,
    `processCpuLoad` decimal
(
    3,
    2
) NOT NULL,
    `deleteSucceededJobsAfter` varchar
(
    32
) DEFAULT NULL,
    `permanentlyDeleteJobsAfter` varchar
(
    32
) DEFAULT NULL,
    `name` varchar
...
(
    ...
    KEY `jobrunr_jobs_state_updated_idx`
(
    `state`,
    `updatedAt`
)
...
(
    ...
    KEY `jobrunr_recurring_job_created_at_idx`
(
    `createdAt`
)
    ) ENGINE = InnoDB
...
(
    ...
    `instrument` longtext DEFAULT NULL CHECK
(
    json_valid
(
    `instrument`
...
(
    ...
    FULLTEXT KEY `idx_fulltext_name`
(
    `name`
),
    FULLTEXT KEY `idx_fulltext_label`
(
    `label`
)
    ) ENGINE = MyISAM
...
(
    ...
    UNIQUE KEY `UK_n2uptwhyydh9ff51ak8wkpi6g`
(
    `tokenValueEncrypted`
)
    ) ENGINE = InnoDB
...
(
    ...
    `offerIdentifier` varchar
(
    255
) DEFAULT NULL,
    KEY `FKk2sfclbecq7f9htqutkw808xs`
(
    `projectIdentifier`
),
    CONSTRAINT `FKk2sfclbecq7f9htqutkw808xs` FOREIGN KEY
(
    `projectIdentifier`
) REFERENCES `projects_datamanager`
(
...
(
    ...
    `digestionEnzyme` varchar
(
    255
) DEFAULT NULL,
    `digestionMethod` varchar
(
    255
) DEFAULT NULL,
    `enrichmentMethod` varchar
(
    255
) DEFAULT NULL,
    `facility` varchar
...
(
    ...
    `technicalReplicateName` varchar
(
    255
) DEFAULT NULL,
    PRIMARY KEY
...
(
    ...
    `qualityControlReference` bigint
(
    20
) DEFAULT NULL,
    PRIMARY KEY
(
    ...
    UNIQUE KEY `UK_ltx4csqq0sndl0vm9tnly0tem`
(
    `qualityControlReference`
),
    CONSTRAINT `FKmxonhr463uotnq2u62dt0gga1` FOREIGN KEY
(
    `qualityControlReference`
) REFERENCES `quality_control_upload`
(
    `id`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FKqrvf0677p2qt9ymasidbqi8sf`
(
    `permissionId`
),
    KEY `FKe3r4gqu0shl2iox9v427uvwdw`
(
    `userRoleId`
),
    CONSTRAINT `FKe3r4gqu0shl2iox9v427uvwdw` FOREIGN KEY
(
    `userRoleId`
) REFERENCES `roles`
(
    ...
    CONSTRAINT `FKqrvf0677p2qt9ymasidbqi8sf` FOREIGN KEY
(
    `permissionId`
...
(
    ...
    KEY `FK5glb6os4rlub6rb133xi1xj0y`
(
    `experimentalGroupId`
),
    CONSTRAINT `FK5glb6os4rlub6rb133xi1xj0y` FOREIGN KEY
(
    `experimentalGroupId`
) REFERENCES `experimental_group`
(
...
(
    ...
    KEY `FKqkox27nsufoigg0vkdpqryga`
(
    `batch_id`
),
    CONSTRAINT `FKqkox27nsufoigg0vkdpqryga` FOREIGN KEY
(
    `batch_id`
...
(
    ...
    UNIQUE KEY `UK_8cs2g0gnxrgknqy4dhri6ltil`
(
    `offerReference`
),
    CONSTRAINT `FKhi0nqiffluv4ov42lkt6u03ac` FOREIGN KEY
(
    `offerReference`
) REFERENCES `purchase_offer`
(
    `id`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FK936j925a6pi06ojgafesihm5b`
(
    `measurement_id`
),
    CONSTRAINT `FK936j925a6pi06ojgafesihm5b` FOREIGN KEY
(
    `measurement_id`
) REFERENCES `ngs_measurements`
(
    `measurement_id`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FKn0pfbmn6xtywvflgsf5q1hbrh`
(
    `measurement_id`
),
    CONSTRAINT `FKn0pfbmn6xtywvflgsf5q1hbrh` FOREIGN KEY
(
    `measurement_id`
) REFERENCES `proteomics_measurement`
(
    `measurement_id`
)
    ) ENGINE = InnoDB
...
(
    ...
    KEY `FKgjtm8gpb7flxkryafvaanmykq`
(
    `roleId`
),
    CONSTRAINT `FKgjtm8gpb7flxkryafvaanmykq` FOREIGN KEY
(
    `roleId`
) REFERENCES `roles`
(
...
(
    ...
    KEY `FK_experiment_id`
(
    `experimentId`
),
    CONSTRAINT `FK_experiment_id` FOREIGN KEY
(
    `experimentId`
) REFERENCES `experiments_datamanager`
(
...
(
    ...
    CONSTRAINT `FK_sample_id` FOREIGN KEY
(
    `sampleId`
) REFERENCES `sample`
(
...
(
    ...
    CONSTRAINT `FK_variable_id` FOREIGN KEY
(
    `variableId`
) REFERENCES `experiments_datamanager_confounding_variables`
(
    `id`
)
    ) ENGINE = InnoDB
