...
class ProjectSpec extends Specification {
    ...
    def "expect projects with the same uuid are equal"() {
        ...
        def projectOne = Project.of(ProjectId.of(uuid), intentOne, ProjectCode.random(), new PersonReference("abc", "my name", "some@email.de"), new PersonReference("abc", "my name2", "some@email.de"), null)
        def projectTwo = Project.of(ProjectId.of(uuid), intentTwo, ProjectCode.random(), new PersonReference("abcd", "my name", "some@email.de"), new PersonReference("abcd", "my name2", "some@email.de"), null)
    ...
    def "expect projects with different uuid are not equal"() {
        ...
        def projectOne = Project.of(ProjectId.of(uuidOne), intent, ProjectCode.random(), new PersonReference("abc", "my name", "some@email.de"), new PersonReference("abc", "my name2", "some@email.de"), null)
        def projectTwo = Project.of(ProjectId.of(uuidTwo), intent, ProjectCode.random(), new PersonReference("abcd", "my name", "some@email.de"), new PersonReference("abcd", "my name2", "some@email.de"), null)
