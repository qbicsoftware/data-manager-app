...
class ProjectSpec extends Specification {
  ...
  def "expect projects with the same uuid are equal"() {
    ...
    def projectOne = Project.of(ProjectId.of(uuid), intentOne, ProjectCode.random())
    def projectTwo = Project.of(ProjectId.of(uuid), intentTwo, ProjectCode.random())
  ...
  def "expect projects with different uuid are not equal"() {
    ...
    def projectTwo = Project.of(ProjectId.of(uuidTwo), intent, ProjectCode.random())
