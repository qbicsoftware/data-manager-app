...
class ProjectSpec extends Specification {
  ...
  def "expect projects with the same uuid are equal"() {
      ...
      def projectManager = ProjectManager.of("Test manager")

      expect: "projects with the same uuid are equal"

      def projectOne = Project.of(ProjectId.of(uuid), intentOne, ProjectCode.random(), projectManager)
      def projectTwo = Project.of(ProjectId.of(uuid), intentTwo, ProjectCode.random(), projectManager)
  ...
  def "expect projects with different uuid are not equal"() {
      ...
      def projectOne = Project.of(ProjectId.of(uuidOne), intent, ProjectCode.random(), projectManager)
      def projectTwo = Project.of(ProjectId.of(uuidTwo), intent, ProjectCode.random(), projectManager)
