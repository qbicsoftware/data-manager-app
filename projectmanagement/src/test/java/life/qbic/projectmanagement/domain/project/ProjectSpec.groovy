...
class ProjectSpec extends Specification {
  ...
  def "expect projects with the same uuid are equal"() {
    ...
    def projectOne = Project.of(ProjectId.of(uuid), intentOne)
    def projectTwo = Project.of(ProjectId.of(uuid), intentTwo)
  ...
  def "expect projects with different uuid are not equal"() {
    ...
    def projectOne = Project.of(ProjectId.of(uuidOne), intent)
    def projectTwo = Project.of(ProjectId.of(uuidTwo), intent)
