 ...
 * <p>
 * Provides access to the persistence layer that handles the {@link User} data storage.
 *
 * @since 1.0.0
 */
public interface UserDataStorage {
   ...
   * <p>
   * Note, that the implementation must not make any assumptions by number of occurrences, even for
   * the email address. The implementation shall return any user entry with the provided email
