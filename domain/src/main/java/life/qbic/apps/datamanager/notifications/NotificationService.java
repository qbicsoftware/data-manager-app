 ...
 * <p>
 * A service to send notifications out to broadcast important business events.
 *
 * @since 1.0.0
 */
public class NotificationService {
    ...
    /**
     * Creates a new notification service. The service will prepare all incoming notifications
     * and send them to the {@link MessageBusInterface}.
     *
