...
public enum NGSMeasurementEditColumn {
  ...
  SAMPLE_NAME("Sample Name", 2, true, true),
  POOL_GROUP("Sample Pool Group", 3, true, true),
  ORGANISATION_ID("Organisation ID", 4, false, true),
  ORGANISATION_NAME("Organisation Name", 5, true, true),
  FACILITY("Facility", 6, false, true),
  INSTRUMENT("Instrument", 7, false, true),
  INSTRUMENT_NAME("Instrument Name", 8, true, true),
  SEQUENCING_READ_TYPE("Sequencing Read Type", 9, false, true),
  LIBRARY_KIT("Library Kit", 10, false, true),
  FLOW_CELL("Flow Cell", 11, false, true),
  SEQUENCING_RUN_PROTOCOL("Sequencing Run Protocol", 12, false, true),
  INDEX_I7("Index i7", 13, false, true),
  INDEX_I5("Index i5", 14, false, true),
  COMMENT("Comment", 15, false, true),
  ;
