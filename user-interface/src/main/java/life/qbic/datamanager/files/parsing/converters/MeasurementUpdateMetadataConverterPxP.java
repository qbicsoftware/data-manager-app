 ...
 * @since <version tag>
 */
public class MeasurementUpdateMetadataConverterPxP implements MetadataConverterV2<MeasurementUpdateInformationPxP>{

  @Override
  public MeasurementUpdateInformationPxP convert(ParsingResult result) {
    // TODO implement
