...
public class NGSMeasurementContentProvider implements DownloadContentProvider {
  ...
  enum NGSMeasurementColumns {
    ...
    SAMPLELABEL(
        "Sample label", 2,
        true),
    ORGANISATIONID("Organisation ID", 3,
        true),
    ORGANISATIONNAME("Organisation Name", 4,
        true),
    FACILITY("Facility", 5,
        false),
    INSTRUMENT("Instrument", 6,
        false),
    INSTRUMENTNAME("Instrument Name", 7,
        true),
    SEQUENCINGREADTYPE("Sequencing Read Type", 8,
        false),
    LIBRARYKIT("Library Kit", 9,
        false),
    FLOWCELL("Flow Cell", 10,
        false),
    RUNPROTOCOL("Sequencing Run Protocol", 11,
        false),
    POOLGROUP("Sample Pool Group", 12,
        true),
    INDEXI7("Index i7", 13,
        false),
    INDEXI5("Index i5", 14,
