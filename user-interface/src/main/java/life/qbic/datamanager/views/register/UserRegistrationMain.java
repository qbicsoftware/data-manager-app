...
public class UserRegistrationMain extends Main implements RegisterUserOutput {
  ...
  public UserRegistrationMain(@Autowired RegisterUserInput registrationUseCase, @Autowired
  UserInformationService userInformationService) {
    this.registrationUseCase = Objects.requireNonNull(registrationUseCase,
        "Registration Use Case cannot be null");
    Objects.requireNonNull(registrationUseCase, "User Information service cannot be null");
