...
```
DATAMANAGEMENT_DB_URL, DATAMANAGEMENT_DB_USER_NAME, DATAMANAGEMENT_DB_USER_PW
FINANCE_DB_URL, FINANCE_DB_USER_NAME, FINANCE_DB_USER_PW
MAIL_HOST, MAIL_PORT, MAIL_USERNAME, MAIL_PASSWORD
ARTEMIS_MODE, ARTEMIS_BROKER_URL, ARTEMIS_USER, ARTEMIS_PASSWORD
DATAMANAGER_VAULT_KEY, DATAMANAGER_VAULT_PATH, DATAMANAGER_VAULT_ENTRY_PASSWORD
```
