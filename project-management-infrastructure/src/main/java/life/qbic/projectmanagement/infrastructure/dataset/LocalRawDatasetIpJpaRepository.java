 ...
 * @since 1.12.0
 */
public interface LocalRawDatasetIpJpaRepository extends
    PagingAndSortingRepository<LocalRawDatasetIpEntry, String>, JpaSpecificationExecutor<LocalRawDatasetIpEntry> {
