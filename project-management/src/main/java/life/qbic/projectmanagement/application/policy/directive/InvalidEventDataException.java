...
public class InvalidEventDataException extends RuntimeException {
  ...
  /**
   * Constructs a new runtime exception with the specified detail message and cause.  <p>Note that the
   ...
   * @since 1.4
   */
  public InvalidEventDataException(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause              the cause.  (A {@code null} value is permitted, and indicates that the
   *                           cause is nonexistent or unknown.)
   * @param enableSuppression  whether or not suppression is enabled or disabled
   * @param writableStackTrace whether or not the stack trace should be writable
   * @since 1.7
   */
  public InvalidEventDataException(String message, Throwable cause, boolean enableSuppression,
