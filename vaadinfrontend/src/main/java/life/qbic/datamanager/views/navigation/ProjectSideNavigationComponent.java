...
public class ProjectSideNavigationComponent extends Div implements
  ...
  private static void addSelectionOptions(MenuItem menuItem) {
  ...
  private void addRecentProjectItem(SubMenu subMenu, ProjectPreview preview) {
    MenuItem recentProject = subMenu.addItem(String.format("%s - %s", preview.projectCode(),
        ...
        (ComponentEventListener<ClickEvent<MenuItem>>) menuItemClickEvent -> ProjectSideNavigationComponent::this::routeToProject));
    recentProject.addClassName("transparent-icon");
  }

  private void routeToProject() {
    RouteParameters routeParameters = new RouteParameters(
        new RouteParam(PROJECT_ID_ROUTE_PARAMETER, context.projectId);
    currentUI.navigate(ProjectInformationMain.class, routeParameters);
