...
public class ExperimentalVariablesComponent extends Card {
    ...
    private void configureComponent() {
        ...
        editButton.addClickListener(clickListener -> listeners.forEach(listener -> listener.onComponentEvent(editEvent)));
    }
     ...
     * @since 1.0.0
     */
    public void subscribeToEditEvent(ComponentEventListener<ExperimentalVariablesEditEvent> listener) {
