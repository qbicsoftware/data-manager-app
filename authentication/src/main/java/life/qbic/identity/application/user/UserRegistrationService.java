...
import life.qbic.identity.domain.user.EncryptedPassword.PasswordValidationException;
import life.qbic.identity.domain.user.FullName;
import life.qbic.identity.domain.user.FullName.FullNameValidationException;
import life.qbic.identity.domain.user.PasswordReset;
import life.qbic.identity.domain.user.User;
import life.qbic.identity.domain.user.UserActivated;
import life.qbic.identity.domain.user.UserEmailConfirmed;
